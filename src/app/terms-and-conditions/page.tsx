        ...
        <CardContent className="prose dark:prose-invert max-w-none text-foreground/80 text-base leading-relaxed px-6 sm:px-8 md:px-10">
          <div className="space-y-8">
            ...
            <section className="space-y-4">
                ...
                <h3 className="text-xl font-semibold text-foreground">3.1 One-Time Subscription</h3>
                <p>Cartera offers a one-time subscription to enable sync and backup features.</p>
                <ul className="list-disc list-inside space-y-2 pl-4">
                    <li>All products currently offered are free.</li>
                    <li>Although subscriptions exist, no billing systems are active yet.</li>
                </ul>
                <h3 className="text-xl font-semibold text-foreground">3.2 Free Trial</h3>
                <p>All subscription features include a free trial period.</p>
                <h3 className="text-xl font-semibold text-foreground">3.3 Refunds</h3>
                <p>Since no billing is active, refunds are not applicable at this time.</p>
            </section>
